...
const list1 = [
  ...
  },
  {
    img: Instagram9,
    name: 'Capsules',
    slug: '/shop/cbd-capsules-for-sale',
  },
  {
    img: Instagram10,
    name: 'Topicals',
  ...
  },
  {
    img: Instagram2,
    name: 'Accessories',
    slug: '/shop/cbd-accessories-for-sale',
  },
];
      ...
      {isMasonry ? (
        <div className='grid grid-cols-2 gap-4 xs:grid-cols-1 md:grid-cols-3 xl:grid-cols-4 2xl:grid-cols-5'>
          {list.map((i, index) => (
            <div
              key={index}
              className='bg-red-200 relative h-[57vh] md:h-[50vw] lg:h-[45vw] xl:h-[35vw] 2xl:h-[30vw]'
            >
              <Image
                src={i.img}
                alt='image-grid'
        ...
        <div className='grid h-full grid-cols-1 gap-2 sm:grid-cols-2 md:grid-cols-3 xl:grid-cols-4 2xl:grid-cols-5'>
          {list1.map((item, index) => (
            <div
              className='w-full h-full min-h-[57vh] sm:min-h-[45vw] md:min-h-[35vw] lg:min-h-[30vw] xl:min-h-[25vw] 2xl:min-h-[20vw]'
              key={index}
            >
